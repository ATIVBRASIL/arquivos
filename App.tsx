      ...
      <div className="w-full max-w-md bg-graphite-800/50 backdrop-blur-md border border-graphite-700 p-8 rounded-2xl shadow-2xl animate-fade-in-up">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="text-center">
            <a href="#" className="text-xs text-text-muted hover:text-amber-500 transition-colors">
  ...
  const HomeView = () => (
    <div className="min-h-screen pt-20 pb-20 animate-fade-in">
      ...
      <section className="relative px-4 md:px-8 lg:px-12 py-8 mb-8">
        <div className="bg-gradient-to-r from-graphite-800 to-black-900 rounded-2xl p-6 md:p-12 border border-graphite-700 relative overflow-hidden group cursor-pointer shadow-2xl" onClick={() => openBook(MOCK_BOOKS[0])}>
