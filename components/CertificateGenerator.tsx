...
const DISABLE_SIGNATURE = false; // mude para true no teste 1, se necessário
const DISABLE_QR = false;        // mude para true no teste 2, se necessário
...
export const generateCertificate = async (
  ...
  try {
    ...
    if (DEBUG_CERT) console.log('[CERT] QR text:', qrText);
    ...
    console.error('[CERT] QR failed:', e);
    throw e;
  }
} else {
