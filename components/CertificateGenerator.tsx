 ...
 * Remove metadados/chunks que frequentemente causam falhas no jsPDF.
 */
...
/**
 * Gera QR Code localmente em canvas e retorna dataURL PNG.
 * Usa import dinâmico de "qrcode" para evitar dependência de rede/CORS.
 */
