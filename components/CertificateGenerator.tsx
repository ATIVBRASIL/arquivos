...
export const generateCertificate = (user: User, book: Book, certCode: string, date: string) => {
  ...
  // MARCA D'ÁGUA FIXA (SEM O ATRIBUTO OPACITY PARA EVITAR ERROS)
  ...
  // Título do Manual (Ajuste de tamanho para evitar cortes)
  doc.setFontSize(22);
  doc.setTextColor(245, 158, 11);
  doc.setFont('helvetica', 'bold');
  doc.text(book.title.toUpperCase(), 148.5, 122, { align: 'center', maxWidth: 220 });

  // 4. EMENTA TÉCNICA (DINÂMICA DA TABELA SUPABASE)
  ...
  doc.setTextColor(11, 13, 16);
  doc.setFont('helvetica', 'bold');
  // Lê o campo technical_skills cadastrado
